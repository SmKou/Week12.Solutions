        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorCategoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PrefersToWrite = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorCategories", x => x.AuthorCategoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookCopies_BookVersions_BookVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OnHoldId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnHolds", x => x.OnHoldId);
                    table.ForeignKey(
                        name: "FK_OnHolds_BookCopies_BookCopyId",
                        column: x => x.BookCopyId,
                        principalTable: "BookCopies",
                        principalColumn: "BookCopyId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OnHolds_Patrons_PatronId",
                        column: x => x.PatronId,
                        principalTable: "Patrons",
                        principalColumn: "PatronId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCopies_BookVersionId",
                table: "BookCopies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookVersions_FormatId",
                table: "BookVersions",
                column: "FormatId");

            migrationBuilder.CreateIndex(
                name: "IX_BookVersions_LanguageId",
                table: "BookVersions",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_BookVersions_PublisherId",
                table: "BookVersions",
                column: "PublisherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatronCategories_CategoryId",
                table: "PatronCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PatronCategories_PatronId",
                table: "PatronCategories",
                column: "PatronId");
